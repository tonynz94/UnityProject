...
public class TrackingController : MonoBehaviour, ITrackableEventHandler {
    ...
    public PageOneScene pageOneSceneScript;
    ...
    void ScriptEnable(bool _enabled)
    {
        ...
        if(pageOneSceneScript._sceneFinished == false)
            blackShadow.SetActive(true); Debug.Log("활성화");
        ...
        if(pageOneSceneScript != null)
            pageOneSceneScript.TrackedOut();
    }
    ...
    IEnumerator ShowObjects(bool _enabled)
    {
        ...
        if (pageOneSceneScript._sceneFinished == false)
            blackShadow.SetActive(false); Debug.Log("비활성화");
        ...
        pageOneSceneScript.PlayStory(pageOneSceneScript.status);
    }
}
