...
public class TrackingController2 : MonoBehaviour, ITrackableEventHandler
{
    ...
    public PageTwoScene pageTwoSceneScript;
    ...
    void ScriptEnable(bool _enabled)
    {
        ...
        if (pageTwoSceneScript._sceneFinished == false)
        ...
        if (pageTwoSceneScript != null)
            pageTwoSceneScript.TrackedOut();
    ...
    IEnumerator ShowObjects(bool _enabled)
    {
        ...
        pageTwoSceneScript.PlayStory(pageTwoSceneScript.status);
    }
